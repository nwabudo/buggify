package com.neookpara.buggify.aop;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.neookpara.buggify.services.*.*(..))") // expression
     ...
     */
    @Pointcut("within(com.neookpara.buggify..*)" +
            " || within(com.neookpara.buggify.services..*)" +
            " || within(com.neookpara.buggify.controller..*)")
    ...
    public void afterThrowingLoginAdvice(JoinPoint joinPoint, Throwable e) {
